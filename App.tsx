    ...
    <div className="bg-[#0c0c0c] text-white selection:bg-gold selection:text-black">
      ...
      <section id="inicio" className="relative min-h-screen flex items-start md:items-center justify-center overflow-hidden pt-28 md:pt-0">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          <p
            className="text-gray-400 text-lg md:text-xl mb-12 max-w-2xl mx-auto font-light tracking-wide leading-relaxed animate-fadeIn"
            style={{ animationDelay: '200ms' }}
          >
            Un refugio para el hombre moderno que valora el ritual clásico. Maestría en tijera y navaja en
          ...
          >
            ...
            <a
              href="#servicios"
              className="border border-white/20 text-white px-12 py-5 font-bold uppercase tracking-[0.2em] text-xs hover:border-gold hover:text-gold transition transform hover:-translate-y-1 w-full sm:w-auto text-center"
            >
              Nuestros Servicios
            </a>
          </div>
      ...
      <section id="locales" className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 uppercase tracking-[0.2em] text-[10px]">
              Encuentra tu barbería más cercana
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            <div className="flex flex-col items-center md:items-start mb-8 md:mb-0">
              <div className="text-2xl font-bold tracking-[0.2em] serif uppercase gold-gradient">
                Buenos Aires
              </div>
              <div className="text-[10px] tracking-[0.4em] uppercase text-gray-500 font-semibold">
                Barbershop
              </div>
            </div>
